...
export default function AlertProvider(props) {
        ...
        if (alertState()) {
            ...
            var focusTrap_1 = function (e) {
                ...
                if (!isTabPressed && !isEscapePressed)
                    return;
                if (isEscapePressed)
                    return setAlertState(undefined);
                if (shiftKey) {
  ...
  <Portal>
      <div role="presentation" class="fixed inset-0 bg-black/30 z-10 overflow-y-auto min-h-screen px-4 flex items-center justify-center" onMouseDown={function (evt) {
            downTarget = evt.target;
        }} onClick={cancelAny} onKeyPress={function (e) {
            return (e.key || e.code) === 'Escape' ? setAlertState(undefined) : null;
        }}>
            
            <div role="dialog" class="max-w-lg px-10 py-8 my-8 bg-white shadow-xl rounded" ref={modal} onMouseDown={function (evt) {
            downTarget = evt.target;
        }}>
              ...
              {((_a = alertState()) === null || _a === void 0 ? void 0 : _a.stateType) === "component" ? (<Dynamic component={(_b = alertState()) === null || _b === void 0 ? void 0 : _b.element} close={function (p) {
                ...
                {((_d = alertState()) === null || _d === void 0 ? void 0 : _d.title) && (<DialogTitle class={"mb-2 text-lg font-700 ".concat(((_e = alertState()) === null || _e === void 0 ? void 0 : _e.intent) === "danger" ? "text-error" : "")}>
...
function InnerForPrompt(props) {
    var _a, _b, _c;
    var _d = createSignal(""), promptInput = _d[0], setPromptInput = _d[1];
